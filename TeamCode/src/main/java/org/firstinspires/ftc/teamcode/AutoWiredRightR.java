...
@Autonomous (name="AutoWiredRightR", group="Autonomous")
public class AutoWiredRightR extends AutoLinearAbstract2022 {
    DcMotor armLift1;
    DcMotor armLift2;
    Servo claw;
    Servo clawLift1;
...
/*public int scanColor() {
    ...
    public void runOpMode() {
        ...
        graph = buildGraph("Olivia");
        {
            ...
            GraphNode E4 = graph.getNode("sE4");
            graph.addEdge(new GraphEdge(start, E4));
            GraphNode pixelDrop = graph.addNode("pixelDrop", -0.1, 1);
            graph.addEdge(new GraphEdge(E4, pixelDrop));
        }
